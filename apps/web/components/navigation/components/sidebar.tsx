...
// Import useSidebar directly from hooks to avoid circular imports
  ...
  (
    ...
    if (collapsible === 'none') {
      return (
        <div
          className={cn(
            'flex h-full w-[var(--sidebar-width)] flex-col bg-sidebar/50 backdrop-filter backdrop-blur-md text-sidebar-foreground',
            className
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[var(--sidebar-width)] bg-sidebar/50 backdrop-filter backdrop-blur-md p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
                '--sidebar-width': '18rem', // SIDEBAR_WIDTH_MOBILE
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'flex h-full flex-col bg-sidebar/50 backdrop-filter backdrop-blur-md  text-sidebar-foreground transition-all duration-200 ease-linear',
...
// Removed SidebarTrigger and SidebarRail components - now imported from separate files
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        'relative flex h-full flex-1 flex-col bg-background/50 backdrop-filter backdrop-blur-md overflow-hidden',
        className
      )}
      {...props}
    />
...
export {
  ...
  SidebarSeparator,
  SidebarTrigger,
  useSidebar, // Keep useSidebar export here for convenience
};
